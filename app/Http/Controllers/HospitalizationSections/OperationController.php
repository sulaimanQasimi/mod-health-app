...
namespace App\Http\Controllers\HospitalizationSections;

use App\Http\Controllers\Controller;
use App\Http\Controllers\Concerns\FormatsOperationSectionItems;
use App\Http\Controllers\Concerns\ProvidesOperationReferralMeta;
