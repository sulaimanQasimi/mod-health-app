...
class StoreDiabetesChartRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'diabetes_chartable_type' => 'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'diabetes_chartable_type.required' => 'Chartable type is required.',
            'diabetes_chartable_type.in' => 'Invalid chartable type.',
            'diabetes_chartable_id.required' => 'Chartable ID is required.',
            'diabetes_chartable_id.integer' => 'Chartable ID must be a valid integer.',
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            ...
            'time' => 'time',
            'date' => 'date',
            'diabetes_chartable_type' => 'chartable type',
            'diabetes_chartable_id' => 'chartable ID',
        ];
    }
}