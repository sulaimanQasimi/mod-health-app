...
class UpdateNurseRequest extends FormRequest
{
    ...
    {
        $nurseId = $this->route('nurse')->id;
        
        return [
            'user_id' => 'nullable|exists:users,id|unique:nurses,user_id,' . $nurseId,
            ...
            'employee_id' => 'required|string|max:255|unique:nurses,employee_id,' . $nurseId,
