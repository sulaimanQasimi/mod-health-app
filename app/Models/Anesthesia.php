...
'operation_scrub_nurse_id','operation_circulation_nurse_id','anesthesia_plan','hospitalization_id','is_operation_approved','is_referred_to_operation','operation_expense_remarks','room_id','bed_id','is_reserved','reserve_reason','anesthesia_type', 'patient_status'];
