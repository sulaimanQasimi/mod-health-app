...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 * Set to empty array to exclude all files and only backup database.
                 */
                'include' => [
                    // Only backup database, no files
                ],
    ...
    'notifications' => [
        'notifications' => [
            // Disable all email notifications to prevent mailpit connection errors
