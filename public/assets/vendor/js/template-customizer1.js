! function() {
    ...
    var t = {
            ...
            8081: function(t) { t.exports = function(t) { return t[1] } },
            3379: function(t) {
                var e = [];

                function s(t) {
                    for (var s = -1, i = 0; i < e.length; i++)
                        if (e[i].identifier === t) { s = i; break }
                    return s
                }
                ...
                t.exports = function(t, s) {
                    var i = function(t) {
                        if (void 0 === e[t]) {
                            ...
                            if (window.HTMLIFrameElement && s instanceof window.HTMLIFrameElement) try { s = s.contentDocument.head } catch (t) { s = null }
                            e[t] = s
                        }
                        return e[t]
                    }(t);
            ...
            9216: function(t) { t.exports = function(t) { var e = document.createElement("style"); return t.setAttributes(e, t.attributes), t.insert(e, t.options), e } },
            3565: function(t, e, s) {
                t.exports = function(t) {
                    var e = s.nc;
    ...
    function s(i) { var a = e[i]; if (void 0 !== a) return a.exports; var o = e[i] = { id: i, exports: {} }; return t[i](o, o.exports, s), o.exports }
    s.m = t, s.n = function(t) { var e = t && t.__esModule ? function() { return t.default } : function() { return t }; return s.d(e, { a: e }), e }, s.d = function(t, e) { for (var i in e) s.o(e, i) && !s.o(t, i) && Object.defineProperty(t, i, { enumerable: !0, get: e[i] }) }, s.o = function(t, e) { return Object.prototype.hasOwnProperty.call(t, e) }, s.r = function(t) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t, "__esModule", { value: !0 }) }, s.b = document.baseURI || self.location.href, s.nc = void 0;
    var i = {};
    ! function() {
        ...
        y.styleTagTransform = p(),
            ...
            e()(m.Z, y), m.Z && m.Z.locals && m.Z.locals;
        var f = '';
        // document.addEventListener("DOMContentLoaded", function (event) {
        //     $('body').append(f);
        // });

        function g(t, e, s) { return e in t ? Object.defineProperty(t, e, { value: s, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = s, t }
            ...
            E = function() {
                function t(e) {
                    var s = e.cssPath,
                        ...
                        E = e.lang;
                    if (function(t, e) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this, t), !this._ssr) {
                        ...
                        if (
                            ...
                            this.pathResolver = v || function(t) { return t },
                            this.settings.styles.length < 2) {
                            var N = this.settings.controls.indexOf("style"); - 1 !== N && (
                                this.settings.controls = this.settings.controls.slice(0, N).concat(this.settings.controls.slice(N + 1)))
                        }
                ...
                return e = t, s = [{
                        key: "setRtl",
                        value: function(t) { this._hasControls("rtl") && (this._setSetting("Rtl", String(t)), window.location.reload()) }
                    },
                    {
                        key: "setStyle",
                        value: function(t) { this._hasControls("style") && (this._setSetting("Style", -1 === ["dark"].indexOf(t) ? "light" : t), window.location.reload()) }
                    },
                    {
                        key: "setTheme",
                        value: function(t) {
                        ...
                        value: function(t) {
                            ...
                            if (this._hasControls("layoutType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                                ...
                                "fixed" === this.settings.layoutType || "fixed-offcanvas" === this.settings.layoutType ? i && s && (window.Helpers.menuPsScroll.destroy(), s = new i(document.querySelector(".menu-inner"), { suppressScrollX: !0, wheelPropagation: !1 }), window.Helpers.menuPsScroll = s) : s && window.Helpers.menuPsScroll.destroy()
                            }
                        }
                    }, {
                        ...
                        value: function() { this._ssr || (this._setSetting("Theme", ""), this._setSetting("Rtl", ""), this._setSetting("Style", ""), this._setSetting("MenuFlipped", ""), this._setSetting("FixedNavbar", ""), this._setSetting("FixedFooter", ""), this._setSetting("LayoutType", "")) }
                    }, { key: "destroy", value: function() { this._ssr || (this._cleanup(), this.settings = null, this.container.parentNode.removeChild(this.container), this.container = null) } }, {
                        key: "_loadSettings",
                        value: function() {
                        ...
                        value: function() {
                            ...
                            //     a = function() { t.container.classList.add("template-customizer-open"), t.update(), t._updateInterval && clearInterval(t._updateInterval), t._updateInterval = setInterval((function() { t.update() }), 1e3) };
                            ...
                            //     n = function() { t.container.classList.remove("template-customizer-open"), t._updateInterval && (clearInterval(t._updateInterval), t._updateInterval = null) };
                            ...
                            //     var c = function(e) { t._loadingState(!0), t.setRtl(e.target.checked) };
                            ...
                            //     var h = function(e) { t._loadingState(!0), e.target.checked ? t.setStyle("dark") : t.setStyle("light") };
                            ...
                            //     var y = function(e) { t._loading || (t._loading = !0, t._loadingState(!0, !0), t.setTheme(e.target.value, !0, (function() { t._loading = !1, t._loadingState(!1, !0) }))) };
                            ...
                            //         var _ = function(e) { return t.setLayoutType(e.target.value) };
                            ...
                            //         var x = function(e) { return t.setDropdownOnHover(e.target.checked) };
                            ...
                            //         var w = function(e) { return t.setLayoutNavbarFixed(e.target.checked) };
                            ...
                            //         var S = function(e) { return t.setLayoutFooterFixed(e.target.checked) };
                            ...
                            // this.setLang(this.settings.lang, !0), e === document ? e.body ? e.body.appendChild(this.container) : window.addEventListener("DOMContentLoaded", (function() { return e.body.appendChild(t.container) })) : e.appendChild(this.container)
                        }
                    },

                    {
                        key: "_initDirection",
                        value: function() { this._hasControls("rtl") && document.documentElement.setAttribute("dir", this.settings.rtl ? "rtl" : "ltr") }
                    }, {
                        key: "_initStyle",
                        value: function() {
                            if (this._hasControls("style")) {
                                var t = this.settings.style;
                                this._insertStylesheet("template-customizer-core-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "core".concat("light" !== t ? "-".concat(t) : "")))), ("light" === t ? ["dark-style"] : ["light-style"]).forEach((function(t) { document.documentElement.classList.remove(t) })), document.documentElement.classList.add("".concat(t, "-style"))
                            }
                        }
                    }, {
                        key: "_initTheme",
                        ...
                        value: function(t, e) {
                            ...
                            function o(t, e, s) {
                                ...
                                var a, o = "sheet" in i ? "sheet" : "styleSheet",
                                    ...
                                    l = setTimeout((function() { clearInterval(a), clearTimeout(l), e.parentNode.removeChild(i), s(!1, t) }), 15e3);
                                a = setInterval((function() { try { i[o] && i[o][n].length && (clearInterval(a), clearTimeout(l), e.parentNode.removeChild(e), s(!0)) } catch (t) {} }), 10), e.parentNode.insertBefore(i, e.nextSibling)
                            }
                            for (var n = 0; n < s.length; n++) o(s[n], t[s[n]], void((a += 1) >= i && e()))
                        }
                    }, {
                        key: "_loadingState",
                        value: function(t, e) { this.container.classList[t ? "add" : "remove"]("template-customizer-loading".concat(e ? "-theme" : "")) }
                    }, { key: "_getElementFromString", value: function(t) { var e = document.createElement("div"); return e.innerHTML = t, e.firstChild } }, {
                        key: "_getSetting",
                        value: function(t) {
                            var e = null,
                                s = this._getLayoutName();
                            try { e = localStorage.getItem("templateCustomizer-".concat(s, "--").concat(t)) } catch (t) {}
                            return String(e || "")
                        }
                    }, {
                        key: "_setSetting",
                        value: function(t, e) { var s = this._getLayoutName(); try { localStorage.setItem("templateCustomizer-".concat(s, "--").concat(t), String(e)) } catch (t) {} }
                    }, {
                        key: "_getLayoutName",
                        value: function() { return document.getElementsByTagName("HTML")[0].getAttribute("data-template") }
                    }, { key: "_removeListeners", value: function() { for (var t = 0, e = this._listeners.length; t < e; t++) this._listeners[t][0].removeEventListener(this._listeners[t][1], this._listeners[t][2]) } }, { key: "_cleanup", value: function() { this._removeListeners(), this._listeners = [], this._controls = {}, this._updateInterval && (clearInterval(this._updateInterval), this._updateInterval = null) } }, { key: "_ssr", get: function() { return "undefined" == typeof window } },
                    {
                        ...
                        value: function(t) {
                            ...
                            return t.split(" ").reduce((function(t, i) { return -1 !== e.settings.controls.indexOf(i) ? (s || !1 !== t) && (t = !0) : s && !0 === t || (t = !1), t }), null)
                        }
                    }, {
                        key: "_getDefaultTheme",
                        value: function(t) { var e; if (!(e = "string" == typeof t ? this._getThemeByName(t, !1) : this.settings.availableThemes[t])) throw new Error('Theme ID "'.concat(t, '" not found!')); return e }
                    }, {
                        key: "_getThemeByName",
                        value: function(t) {
