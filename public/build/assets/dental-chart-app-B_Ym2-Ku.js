            ...
            <div class="row">
                ...
                <div class="col-12" data-implant-fields style="display:none;">
                    <div class="border rounded p-3 mb-3 bg-body-secondary">
                        <h6 class="mb-3">Implant Details</h6>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="implant_notes" class="form-control" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
