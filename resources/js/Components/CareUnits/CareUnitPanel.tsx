...
import { CARE_UNIT_CARD_CLASS } from './careUnitUi';

interface CareUnitPanelProps {
    title: string;
    icon: string;
...
export default function CareUnitPanel({
    title,
    icon,
    iconClassName,
    iconBgClassName,
    ...
    return (
        <section className={`${CARE_UNIT_CARD_CLASS} ${isTable ? '' : 'p-5'}`}>
            <div
