...
interface HemodialysisSessionFiltersProps {
    filters: Filters;
...
export default function HemodialysisSessionFilters({
    filters,
    filterOptions,
    processing,
    onChange,
    onSubmit,
    onReset,
}: HemodialysisSessionFiltersProps) {
                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div>
                        ...
                        <PersianDateInput
                            ...
                            onChange={(value) => onChange({ ...filters, session_date: value })}
                        />
                    </div>
                    <div>
