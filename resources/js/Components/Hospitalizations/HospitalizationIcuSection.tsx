                    ...
                    <ModalBody className={`space-y-4 ${MODAL_BODY_CLASS}`}>
                        {metaLoading ? (
                            ...
                            <>
                                ...
                                <div>
                                    <Label htmlFor="icu-referral-department">{t('global.department')}</Label>
                                    <SearchableSelect
                                        id="icu-referral-department"
                                        className="mt-2"
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div>
                                        <Label htmlFor="icu-referral-room">{t('global.rooms')}</Label>
                                        <SearchableSelect
                                            id="icu-referral-room"
                                            className="mt-2"
                                            value={form.room_id}
                                            onChange={(value) =>
                                                setForm((prev) => ({
                                    ...
                                    <div>
                                        <Label htmlFor="icu-referral-bed">{t('global.beds')}</Label>
                                        <SearchableSelect
                                            id="icu-referral-bed"
                                            className="mt-2"
                                            value={form.bed_id}
