...
import { ICU_CARD_CLASS } from './icuUi';
...
export default function IcuNavTabs({ active, urls }: IcuNavTabsProps) {
    ...
    return (
        <nav className={`${ICU_CARD_CLASS} p-2`}>
