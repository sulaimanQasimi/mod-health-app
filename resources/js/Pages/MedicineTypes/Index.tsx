...
export default function IndexMedicineTypes({
    medicineTypes,
    filters: serverFilters,
    permissions,
    urls,
}: {
    medicineTypes: PaginatedResult<MedicineTypeItem>;
                        ...
                        <Table>
                            <TableHead>
                                <TableRow variant="header">
                                    ...
                                    <TableHeader>{typeLabel}</TableHeader>
                                    <TableHeader align="center">{t('global.actions')}</TableHeader>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {medicineTypes.data.map((item, index) => (
                                    <TableRow key={item.id}>
                                        <TableCell>{(medicineTypes.meta.from ?? 1) + index}</TableCell>
