...
export default function EditUser({ user, formData, urls }: EditUserProps) {
    const { t } = useTranslation();

    return (
        <DashboardLayout>
            <Head title={t('global.edit_user')} />
            ...
            <div className="mx-auto max-w-7xl">
                <Card className="shadow-sm">
                    ...
                    <UserForm mode="edit" formData={formData} urls={urls} user={user} />
                </Card>
            </div>
        </DashboardLayout>
    );
