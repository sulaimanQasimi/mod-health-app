        ...
        <div class="content-wrapper">
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="collapse" id="filterCollapse">
                    <div class="card-body">
                        <form method="GET" action="{{ route('anesthesias.rejected') }}" id="filterForm">
                            <div class="row g-3">
                                {{-- Search Input --}}
                                <div class="col-md-4">
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-md-4 d-flex align-items-end gap-2">
                                    ...
                                    <a href="{{ route('anesthesias.rejected') }}" class="btn btn-outline-secondary">
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mb-0">{{ localize('global.no_anesthesias_found') ?: 'No rejected anesthesias found' }}</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
