    ...
    <div class="col-xl-8 mx-auto">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Depot to Depot Movement</h5>
                <a href="{{ route('depots.transactions.index') }}" class="btn btn-outline-secondary btn-sm">Back</a>
            </div>
            <div class="card-body">
                <form action="{{ route('depots.movements.depot_to_depot.store') }}" method="POST" autocomplete="off" onsubmit="return confirm('Move stock between depots?')">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="to_depot_id">Destination Depot</label>
