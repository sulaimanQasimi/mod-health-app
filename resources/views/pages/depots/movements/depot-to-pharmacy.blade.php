    ...
    <div class="col-xl-8 mx-auto">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Depot to Pharmacy Movement</h5>
                <a href="{{ route('depots.transactions.index') }}" class="btn btn-outline-secondary btn-sm">Back</a>
            </div>
            <div class="card-body">
                <form action="{{ route('depots.movements.depot_to_pharmacy.store') }}" method="POST" autocomplete="off" onsubmit="return confirm('Move stock from depot to pharmacy?')">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="from_depot_id">Source Depot</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="pharmacy_id" id="pharmacy_id" class="form-select select2 @error('pharmacy_id') is-invalid @enderror" required>
