                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" autocomplete="off" name="join_date" id="join_date" value="{{ old('join_date') }}" class="form-control datepicker_dari @error('join_date') is-invalid @enderror">
                                        @error('join_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_nephrologist" id="is_nephrologist" value="1" {{ old('is_nephrologist') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_eye_doctor" id="is_eye_doctor" value="1" {{ old('is_eye_doctor') ? 'checked' : '' }}>
