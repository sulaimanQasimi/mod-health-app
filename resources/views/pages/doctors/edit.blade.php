                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" autocomplete="off" name="join_date" id="join_date" value="{{ old('join_date', $doctor->join_date ? verta($doctor->join_date)->format('Y-m-d') : '') }}" class="form-control datepicker_dari @error('join_date') is-invalid @enderror">
                                        @error('join_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            @php
                                                $isDentist = old('is_dentist') !== null 
                                                    ? (bool)old('is_dentist') 
                                                    : ($doctor->is_dentist ?? false);
                                            @endphp
                                            <input class="form-check-input" type="checkbox" name="is_dentist" id="is_dentist" value="1" {{ $isDentist ? 'checked' : '' }}>
