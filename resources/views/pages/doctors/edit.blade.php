                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="father_name" id="father_name" value="{{ old('father_name', $doctor->father_name) }}" class="form-control @error('father_name') is-invalid @enderror" placeholder="Enter father name">
                                        @error('father_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="contact_number" id="contact_number" value="{{ old('contact_number', $doctor->contact_number) }}" class="form-control @error('contact_number') is-invalid @enderror" placeholder="Phone number" required>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="address" id="address" rows="3" class="form-control @error('address') is-invalid @enderror" placeholder="Full address">{{ old('address', $doctor->address) }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="specialization" id="specialization" value="{{ old('specialization', $doctor->specialization) }}" class="form-control @error('specialization') is-invalid @enderror" placeholder="e.g., Cardiology">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="qualification" id="qualification" value="{{ old('qualification', $doctor->qualification) }}" class="form-control @error('qualification') is-invalid @enderror" placeholder="e.g., MBBS, MD">
                                        @error('qualification')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="room_no" id="room_no" value="{{ old('room_no', $doctor->room_no) }}" class="form-control @error('room_no') is-invalid @enderror" placeholder="Room number">
                                        @error('room_no')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2 @error('clinic_type') is-invalid @enderror" name="clinic_type" id="clinic_type">
                                            <option value="">{{ localize('global.select') }}</option>
                                            <option value="hospital" {{ old('clinic_type', $doctor->clinic_type) == 'hospital' ? 'selected' : '' }}>Hospital</option>
                                            <option value="clinic" {{ old('clinic_type', $doctor->clinic_type) == 'clinic' ? 'selected' : '' }}>Clinic</option>
                                        </select>
                                        @error('clinic_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="join_date" id="join_date" value="{{ old('join_date', $doctor->join_date ? \Carbon\Carbon::parse($doctor->join_date)->format('Y-m-d') : '') }}" class="form-control @error('join_date') is-invalid @enderror">
                                        @error('join_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <select class="form-control select2 @error('branch_id') is-invalid @enderror" name="branch_id" id="branch_id" required>
                                            ...
                                            @foreach($branches as $value)
                                                <option value="{{ $value->id }}"
                                                    {{ old('branch_id', $doctor->branch_id) == $value->id ? 'selected' : '' }}>
                                                {{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('branch_id')
