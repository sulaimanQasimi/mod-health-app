            ...
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @php
                            $hasActiveFiltersNew = request()->hasAny(['patient_name', 'card_number', 'father_name', 'search']);
                        @endphp
                        <div class="card border-0 bg-light rounded-3 mb-4 shadow-sm">
                            <div class="card-header bg-transparent border-0 py-3 cursor-pointer d-flex align-items-center justify-content-between" data-bs-toggle="collapse" data-bs-target="#icuNewFilterCollapse" aria-expanded="{{ $hasActiveFiltersNew ? 'true' : 'false' }}" aria-controls="icuNewFilterCollapse" role="button">
