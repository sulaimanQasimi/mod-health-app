            ...
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @php
                            $hasActiveFiltersRejected = request()->hasAny(['patient_name', 'card_number', 'father_name', 'search', 'per_page']) && (request()->filled('patient_name') || request()->filled('card_number') || request()->filled('father_name') || request()->filled('search') || request('per_page', 15) != 15);
                        @endphp
                        <div class="card mb-4 shadow-sm">
                            <div class="card-header bg-none border-0 py-3 cursor-pointer d-flex align-items-center justify-content-between" data-bs-toggle="collapse" data-bs-target="#icuRejectedFilterCollapse" aria-expanded="{{ $hasActiveFiltersRejected ? 'true' : 'false' }}" aria-controls="icuRejectedFilterCollapse" role="button">
