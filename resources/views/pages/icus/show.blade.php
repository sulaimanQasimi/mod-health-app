                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('icus.index') }}"
                                    class="text-decoration-none">{{ localize('global.icus') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ localize('global.icu_details') }}
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="h4 mb-0">
                            <i class="bx bx-tv me-2 text-primary"></i>
                            {{ localize('global.icu_details') }}
                        </h2>
                        <div class="d-flex gap-2">
                            <a href="{{ route('icus.edit', $icu->id) }}" class="btn btn-primary btn-sm">
                                <i class="bx bx-edit me-1"></i>
                                {{ localize('global.edit') }}
                            </a>
                            <a href="{{ route('icus.index') }}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="text-center p-3 border rounded bg-body-secondary">
                                        <div class="text-body-secondary small mb-1">{{ localize('global.last_name') }}</div>
                                        <div class="fw-bold">
                                            <i class="bx bx-user me-1 text-primary"></i>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="text-center p-3 border rounded bg-body-secondary">
                                        <div class="text-body-secondary small mb-1">{{ localize('global.phone') }}</div>
                                        <div class="fw-bold">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="text-center p-3 border rounded bg-body-secondary">
                                        <div class="text-body-secondary small mb-1">{{ localize('global.nid') }}</div>
                                        <div class="fw-bold">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="text-center p-3 border rounded bg-body-secondary">
                                        <div class="text-body-secondary small mb-1">{{ localize('global.province') }}</div>
                                        <div class="fw-bold">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="text-center p-3 border rounded bg-body-secondary">
                                        <div class="text-body-secondary small mb-1">{{ localize('global.district') }}</div>
                                        <div class="fw-bold">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="text-center p-3 border rounded bg-body-secondary">
                                        <div class="text-body-secondary small mb-1">{{ localize('global.referred_by') }}
                                        </div>
                                        <div class="fw-bold">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="text-center p-3 border rounded bg-body-secondary">
                                        <div class="text-body-secondary small mb-1">{{ localize('global.creation_date') }}
                                        </div>
                                        <div class="fw-bold">
                ...
                @if ($icu->status == 'approved')
                    ...
                    <div class="accordion mt-4" id="consultationsAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="consultationsHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#consultationsCollapse" aria-expanded="false"
                            ...
                            <div id="consultationsCollapse" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div id="icu-consultation-section-container" data-icu='@json($icu)' data-permissions='@json([
                    ...
                    <div class="accordion mt-4" id="visitsAccordion">
                        <div class="accordion-item">
                            ...
                            <div id="visitsCollapse" class="accordion-collapse collapse" aria-labelledby="visitsHeader"
                                ...
                                <div class="accordion-body p-0">
                                    ...
                                    @if ($icu->is_discharged == '0')
                                        <div class="p-3 border-bottom">
                                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#createVisitModal{{ $icu->id }}"
                    ...
                    <div class="accordion mt-4" id="prescriptionAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="prescriptionHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#prescriptionCollapse" aria-expanded="false"
                            ...
                            <div id="prescriptionCollapse" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div id="icu-prescription-section-container" data-icu='@json($icu)' data-permissions='@json([
                    ...
                    <div class="accordion mt-4" id="adviceAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="adviceHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#adviceCollapse" aria-expanded="false"
                            ...
                            <div id="adviceCollapse" class="accordion-collapse collapse" aria-labelledby="adviceHeader"
                    ...
                    <div class="accordion mt-4" id="labTestsAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="labTestsHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#labTestsCollapse" aria-expanded="false"
                            ...
                            <div id="labTestsCollapse" class="accordion-collapse collapse" aria-labelledby="labTestsHeader"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('lab_tests.store') }}" method="POST">
                                        ...
                                        <input type="hidden" id="hospitalization_id{{ $icu->id }}" name="hospitalization_id"
                                            value="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="lab_type_id{{ $icu->id }}">{{ localize('global.lab_type') }}</label>
                    ...
                    <div class="accordion mt-4" id="proceduresAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="proceduresHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#proceduresCollapse" aria-expanded="false"
                            ...
                            <div id="proceduresCollapse" class="accordion-collapse collapse" aria-labelledby="proceduresHeader"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <select class="form-control select2" name="icu_procedure_type_id"
                                                        id="icu_procedure_type_id" required>
                                                        <option value="">{{ localize('global.select') }}
                                                        </option>
                    ...
                    <div class="accordion mt-4" id="dailyProgressAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="dailyProgressHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#dailyProgressCollapse" aria-expanded="false"
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="hr" placeholder="Heart Rate">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="t" placeholder="Temperature">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <h6 class="text-primary border-bottom pb-2 mt-3">
                                                    {{ localize('global.neurological_assessment') }}
                                                </h6>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pupils" placeholder="Pupils">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ localize('global.s1s2') }}</label>
                                                    <input type="text" class="form-control" name="s1s2" placeholder="S1/S2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <h6 class="text-primary border-bottom pb-2 mt-3">
                                                    {{ localize('global.system_assessment') }}
                                                </h6>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="renal" placeholder="Renal">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="lab_ids{{ $icu->id }}">{{ localize('global.lab_ids') }}</label>
                                                    <select class="form-control select2" name="lab_ids[]" id="lab_ids" multiple>
                                                        <option value="">{{ localize('global.select') }}</option>
                                                        @foreach ($labTypes as $value)
                                                            <option value="{{ $value->id }}" {{ old('name') == $value->id ? 'selected' : '' }}>
                                                                {{ $value->name }}
                    ...
                    <div class="accordion mt-4" id="hospitalizationAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="hospitalizationHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    ...
                                    <span class="badge bg-primary ms-2">{{ count($icu->hospitalizations) }}</span>
                                </button>
                            </h2>
                            <div id="hospitalizationCollapse" class="accordion-collapse collapse"
                                aria-labelledby="hospitalizationHeader" data-bs-parent="#hospitalizationAccordion">
                                <div class="accordion-body p-0">
                                    <!-- Add Hospitalization Button -->
                                    @if ($icu->is_discharged == 0)
                                        <div class="p-3 border-bottom">
                                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#createHospitalizationModal{{ $icu->id }}">
                                                <i class="bx bx-plus"></i>
                                            </button>
                                        </div>
                                    @endif
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('hospitalizations.store') }}" method="POST">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="reason{{ $icu->id }}">{{ localize('global.reason') }}</label>
                                                    <textarea class="form-control" id="reason{{ $icu->id }}" name="reason"
                                                        rows="3" required placeholder="Reason for hospitalization"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="remarks{{ $icu->id }}">{{ localize('global.remarks') }}</label>
                                                    <textarea class="form-control" id="remarks{{ $icu->id }}" name="remarks"
                                            ...
                                            <div class="col-12">
                                                <h6 class="text-primary border-bottom pb-2 mt-3">
                                                    {{ localize('global.room_bed_assignment') }}
                                                </h6>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                    ...
                    <div class="accordion mt-4" id="dischargeAccordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="dischargeHeader">
                                <button class="accordion-button collapsed bg-body-secondary text-body" type="button"
                                    ...
                                    {{ localize('global.discharge_move_patient') }}
                                    @if ($icu->is_discharged == '1')
                                        <span class="badge bg-success ms-2">{{ localize('global.discharged') }}</span>
                                    @else
                                        <span class="badge bg-warning ms-2">{{ localize('global.active') }}</span>
                                    @endif
                                </button>
                            </h2>
                            <div id="dischargeCollapse" class="accordion-collapse collapse" aria-labelledby="dischargeHeader"
                                ...
                                <div class="accordion-body p-0">
                                    ...
                                    @if ($icu->is_discharged == '0')
                                        <div class="p-3 border-bottom">
                                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#createDischargeModal{{ $icu->id }}">
                                                <i class="bx bx-plus"></i>
                                            </button>
                                        </div>
                                    @endif
                                ...
                                <form action="{{ route('icus.update', $icu) }}" method="POST">
                                    ...
                                    <div id="died_options{{ $icu->id }}" style="display: none;" class="mt-3">
                                        <div class="alert alert-danger">
                                            <h6 class="alert-heading">
                                                <i class="bx bx-x-circle me-2"></i>{{ localize('global.death_details') }}
                                            </h6>
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="hidden" id="is_discharged_died{{ $icu->id }}" name="is_discharged"
                                                value="1">
                                        </div>
                                    </div>
                                    ...
                                    <div id="moved_options{{ $icu->id }}" style="display: none;" class="mt-3">
                                        <div class="alert alert-warning">
                                            <h6 class="alert-heading">
                                                <i class="bx bx-transfer me-2"></i>{{ localize('global.transfer_details') }}
                                            </h6>
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" id="brief_history{{ $icu->id }}"
                                                name="brief_history" rows="3" placeholder="Enter brief history"></textarea>
                                            <input type="hidden" id="is_discharged_moved{{ $icu->id }}" name="is_discharged"
                                                value="1">
                                            <input type="hidden" name="transfer_date" value="{{ \Carbon\Carbon::now() }}">
                                        </div>
                                    </div>
                            </div>
                            <div class="modal-footer">
