                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('hospitalizations.edit', $hospitalization->id) }}"><span><i
                                                                class="bx bx-edit"></i></span></a>
                                                    <a
                                                        href="{{ route('hospitalizations.destroy', $hospitalization->id) }}"><span><i
                                                                class="bx bx-trash text-danger"></i></span></a>
                                            ...
                                            <form action="{{ route('icus.update', $icu) }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="discharge_remark{{ $icu->id }}">
                                                        ...
                                                        <textarea class="form-control" id="discharge_remark{{ $icu->id }}" name="discharge_remark"
                                                            rows="3"></textarea>
                                                    ...
                                                    <div id="died_options{{ $icu->id }}" style="display: none;">
                                                        ...
                                                        <textarea class="form-control mt-2" id="cause_of_death{{ $icu->id }}" name="cause_of_death"
                                                            rows="3"></textarea>
