                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group input-daterange" id="bs-datepicker-daterange">
                                    <input type="text" name="start_date" placeholder="{{ localize('global.from') }}"
                                           autocomplete="off" class="form-control datepicker_dari" value="{{ request('start_date') }}" />
                                    <span class="input-group-text">...</span>
                                    <input type="text" name="end_date" placeholder="{{ localize('global.to') }}"
                                           autocomplete="off" class="form-control datepicker_dari" value="{{ request('end_date') }}" />
                                </div>
                            </div>
                            <div class="col-md-2">
