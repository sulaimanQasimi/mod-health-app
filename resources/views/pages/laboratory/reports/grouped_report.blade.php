            ...
            <div class="test-section">
                <div class="test-details">
                    ...
                    <table class="test-meta">
                        <tr>
                            <th colspan="6">{{ $testRegistration->labType ? $testRegistration->labType->name : localize('global.test_name') }}</th>
                        </tr>
                        <tr>
                            ...
                            <td>{{ $testRegistration->registration_date ? \Verta($testRegistration->registration_date)->formatJalaliDate() : '—' }}</td>
                        </tr>
                        <tr>
                    ...
                    @elseif($hasTextResult)
                        ...
                        <div class="text-result-section">
                            <h4>{{ localize('global.test_result') }}</h4>
