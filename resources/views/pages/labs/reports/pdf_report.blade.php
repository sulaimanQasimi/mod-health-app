...
<body>
    <h2 class="excel_table_title">{{ localize('global.lab_tests_report_title') }}</h2>
                    ...
                    <tr>
                        ...
                        <td> @if ($item->status == '0')
                            <span class="badge rounded-pill bg-primary">
                                {{ localize('global.under_lab_tests') }}
                            </span>              
                        @else
                        <span class="badge rounded-pill bg-success">
                                {{ localize('global.completed_lab_tests') }}
                            </span> 
                        @endif</td>
                        <td>{{ $item->doctor_name }}</td>
                        <td>{{ $item->lab_type_section_name }}</td>
