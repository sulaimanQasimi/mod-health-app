                ...
                <div class="col-md-8">
                    <div class="card shadow-lg mb-4">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            <h5 class="mb-0"><i class="bx bx-edit me-2"></i>{{ localize('global.edit') }}</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('militery_types.update', $militeryType->id) }}" method="post" autocomplete="off">
                                @method('PUT')
                                @csrf
                                <div class="mb-4">
                                    ...
                                    <input 
                                        ...
                                        id="name" 
                                        name="name" 
                                        value="{{ old('name', $militeryType->name) }}" 
