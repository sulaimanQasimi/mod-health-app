                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="id_card" id="id_card"
                                            value="{{ $filters['id_card'] ?? old('id_card') }}" class="form-control">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="age" id="age"
                                            value="{{ $filters['age'] ?? old('age') }}" class="form-control">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control select2" name="gender" id="gender">
                                            ...
                                            <option value="0"
                                                {{ ($filters['gender'] ?? old('gender')) == '0' ? 'selected' : '' }}>
                                                {{ localize('global.male') }}</option>
                                            <option value="1"
                                                {{ ($filters['gender'] ?? old('gender')) == '1' ? 'selected' : '' }}>
                                                {{ localize('global.female') }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control select2" name="job_category" id="job_category">
                                            <option value="">{{ localize('global.select') }}</option>
                                            <option value="0"
                                                {{ ($filters['job_category'] ?? old('job_category')) == '0' ? 'selected' : '' }}>
                                                {{ localize('global.military') }}</option>
                                            <option value="1"
                                                {{ ($filters['job_category'] ?? old('job_category')) == '1' ? 'selected' : '' }}>
                                                {{ localize('global.civilian') }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control select2" name="type">
                                            <option value="">{{ localize('global.select') }}</option>
                                            <option value="0"
                                                {{ ($filters['type'] ?? old('type')) == '0' ? 'selected' : '' }}>
                                                {{ localize('global.mod') }}</option>
                                            <option value="1"
                                                {{ ($filters['type'] ?? old('type')) == '1' ? 'selected' : '' }}>
                                                {{ localize('global.recipient') }}</option>
                                            <option value="2"
                                                {{ ($filters['type'] ?? old('type')) == '2' ? 'selected' : '' }}>
                                                {{ localize('global.family') }}</option>
                                        </select>
                                    </div>
                                        ...
                                        <select class="form-control select2" name="referred_by">
                                            ...
                                            @foreach ($recipients as $value)
                                                <option value="{{ $value->id }}"
                                                    {{ ($filters['referred_by'] ?? old('referred_by')) == $value->id ? 'selected' : '' }}>
                                                    {{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control select2" name="province_id" id="province_id"
                                                ...
                                                @foreach ($provinces as $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ ($filters['province_id'] ?? old('province_id')) == $value->id ? 'selected' : '' }}>
                                ...
                                <div class="row g-2 mt-2">
                                    <div class="col-md-4">
                                        <button type="submit" class="btn btn-label-primary">
                                            ...
                                            <span>{{ localize('global.documents.search') }}</span>
                                        </button>
                                    ...
                                    <div class="col-md-3">
                                        <label for="per_page"
                                            class="form-label">{{ localize('global.per_page') }}</label>
                                        <select class="form-select" name="per_page" id="per_page">
                                            <option value="10"
                                                {{ ($filters['per_page'] ?? 15) == 10 ? 'selected' : '' }}>10</option>
                                            <option value="15"
                                                {{ ($filters['per_page'] ?? 15) == 15 ? 'selected' : '' }}>15</option>
                                            <option value="25"
                                                {{ ($filters['per_page'] ?? 15) == 25 ? 'selected' : '' }}>25</option>
                                            <option value="50"
                                                {{ ($filters['per_page'] ?? 15) == 50 ? 'selected' : '' }}>50</option>
                                            <option value="100"
                                                {{ ($filters['per_page'] ?? 15) == 100 ? 'selected' : '' }}>100</option>
                                            <option value="all"
                                                {{ ($filters['per_page'] ?? '') === 'all' ? 'selected' : '' }}>
                                                {{ localize('global.all') ?? 'All' }}</option>
                                        </select>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="table-responsive m-1" id="app">
                    @if (isset($items))
                        ...
                        <div class="card-body border-bottom">
                            ...
                            <div class="d-flex justify-content-end align-items-end">
                                <a href="{{ route('patients.report-search', array_merge($reportExportParams ?? [], ['export' => 'excel'])) }}"
                                    class="btn btn-success btn-lg px-4">
                                    <i class="fas fa-file-excel me-2"></i>
                                    <span class="fw-medium">Excel</span>
                                </a>
                                <a href="{{ route('patients.report-search', array_merge($reportExportParams ?? [], ['export' => 'print'])) }}"
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center py-3">
                            ...
                            <span class="badge bg-primary rounded-pill">
                                ...
                                @if ($items->hasPages())
                                    ({{ $items->firstItem() }}-{{ $items->lastItem() }} {{ localize('global.of') }}
                                    {{ $items->total() }})
                                @endif
                            </span>
                        </div>
                        <div class="card-body p-0">
                                    ...
                                    <tbody>
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge bg-light text-dark border">{{ $item->nid }}</span>
                                                </td>
                                                <td><span
                                                        class="badge bg-light text-dark border">{{ $item->id_card }}</span>
                                                </td>
                                                <td><span class="text-muted">{{ $item->referral_name }}</span></td>
                                                <td class="text-center"><span
                                                        class="badge bg-info rounded-pill">{{ $item->age }}</span></td>
                                                <td class="text-center">
                                                    @if ($item->gender == '0')
                                                        <span
                                                            class="badge bg-primary rounded-pill">{{ localize('global.male') }}</span>
                                                    @else
                                                        <span
                                                            class="badge bg-pink rounded-pill">{{ localize('global.female') }}</span>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                                    @if ($item->job_category == '0')
                                                        <span
                                                            class="badge bg-warning rounded-pill">{{ localize('global.military') }}</span>
                                                    @else
                                                        <span
                                                            class="badge bg-secondary rounded-pill">{{ localize('global.civilian') }}</span>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                                    @if ($item->type == '0')
                                                        <span
                                                            class="badge bg-success rounded-pill">{{ localize('global.mod') }}</span>
                                                    @elseif($item->type == '1')
                                                        <span
                                                            class="badge bg-info rounded-pill">{{ localize('global.recipient') }}</span>
                                                    @else
                                                        <span
                                                            class="badge bg-secondary rounded-pill">{{ localize('global.family') }}</span>
                                                    @endif
                                                </td>
                                                <td><span class="text-muted">{{ $item->recipient->name ?? '—' }}</span>
                                                </td>
                                                <td><span
                                                        class="badge bg-light text-dark border">{{ $item->province->name_dr ?? '—' }}</span>
                                                </td>
                                                <td><span
                                                        class="badge bg-light text-dark border">{{ $item->district->name_dr ?? '—' }}</span>
                                                </td>
                                                <td><span
                                                        class="badge bg-light text-dark border">{{ verta($item->registration_date)->format('Y/m/d') }}</span>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="13" class="text-center py-5 text-muted">
                                                    ...
                                                    <p class="mb-0">
                                                        {{ localize('global.try_adjusting_your_search_criteria') }}</p>
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                            ...
                            @if ($items->hasPages())
                                <div
                                    class="card-footer d-flex justify-content-between align-items-center flex-wrap gap-2 py-3">
                                    <div class="text-muted small">
                                        {{ localize('global.showing') }} {{ $items->firstItem() }}
                                        {{ localize('global.to') }} {{ $items->lastItem() }}
                                        {{ localize('global.of') }} {{ $items->total() }}
                                        {{ localize('global.results') }}
                                    </div>
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        <form method="GET" action="{{ route('patients.report-search') }}"
                                            class="d-inline-flex align-items-center gap-2" id="report-per-page-form">
                                            @foreach ($reportExportParams ?? [] as $key => $val)
                                                <input type="hidden" name="{{ $key }}"
                                                    value="{{ $val }}">
                                            @endforeach
                                            <label for="per-page-select"
                                                class="form-label mb-0 small">{{ localize('global.show') }}:</label>
                                            <select class="form-select form-select-sm" name="per_page"
                                                id="per-page-select" style="width: auto;"
                                                onchange="document.getElementById('report-per-page-form').submit()">
                                                <option value="10" {{ $items->perPage() == 10 ? 'selected' : '' }}>10
                                                </option>
                                                <option value="15" {{ $items->perPage() == 15 ? 'selected' : '' }}>15
                                                </option>
                                                <option value="25" {{ $items->perPage() == 25 ? 'selected' : '' }}>25
                                                </option>
                                                <option value="50" {{ $items->perPage() == 50 ? 'selected' : '' }}>50
                                                </option>
                                                <option value="100" {{ $items->perPage() == 100 ? 'selected' : '' }}>
                                                    100</option>
                                                <option value="all"
                                                    {{ ($filters['per_page'] ?? '') === 'all' ? 'selected' : '' }}>
                                                    {{ localize('global.all') ?? 'All' }}</option>
                    ...
                    @else
                        <div class="p-4 text-center text-muted">
                            ...
                            <p class="mb-0 mt-2">
                                {{ localize('global.use_filters_above_to_search') ?? 'Use the search form above to view patient report.' }}
                            </p>
                        </div>
                    @endif
                </div>
