    ...
    <div class="row">
        ...
        <div class="col-12 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="appointment_clinic_type_tab2">{{ localize('global.clinic_type') }} <span class="text-danger">*</span></label>
                        <select class="form-control select2" name="appointment_clinic_type" id="appointment_clinic_type_tab2" onchange="loadDoctorsByDepartment(document.getElementById('appointment_department_id').value, this.form)">
                            <option value="">{{ localize('global.select') }}...</option>
