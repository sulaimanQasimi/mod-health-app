<form id="patient-form-tab3" action="{{ route('patients.store') }}" method="POST">
    @csrf
    <div class="row">
        <div class="col-md-3">
            <div class="mb-3">
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <div class="row g-0">
                    <div class="col-4">
                        <input type="number" class="form-control" name="age_year" id="age_year_tab3" placeholder="{{ localize('global.year') }}" min="0" max="150" onchange="updateAgeValue('tab3')" value="{{ old('age_year') }}" style="padding: 0;">
                    </div>
                    <div class="col-4">
                        <input type="number" class="form-control" name="age_day" id="age_day_tab3" placeholder="{{ localize('global.day') }}" min="0" max="31" onchange="updateAgeValue('tab3')" value="{{ old('age_day') }}" style="padding: 0;">
                    </div>
                    <div class="col-4">
                        <input type="number" class="form-control" name="age_month" id="age_month_tab3" placeholder="{{ localize('global.month') }}" min="0" max="11" onchange="updateAgeValue('tab3')" value="{{ old('age_month') }}" style="padding: 0;">
                    </div>
                </div>
                <input type="hidden" name="age" id="age_tab3" value="{{ old('age') }}" required>
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="text" name="referral_name" required id="referral_name"
                    value="{{ old('referral_name') }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="text" name="referral_last_name" id="referral_last_name"
                    value="{{ old('referral_last_name') }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="text" name="referral_father_name" id="referral_father_name"
                    value="{{ old('referral_father_name') }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="text" name="referral_nid" required id="referral_nid"
                    value="{{ old('referral_nid') }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="text" name="referral_id_card" id="referral_id_card"
                    value="{{ old('referral_id_card') }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="text" name="referral_phone" id="referral_phone"
                    value="{{ old('referral_phone') }}" class="form-control">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <select class="form-control select2" name="referral_recipient" required >
                    ...
                    <option  {{ old('referral_recipient') == $value->id ? 'selected' : ''}} value="{{ $value->id }}" >
                        {{ $value->name }}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <select class="form-control select2" name="relation_id" required >
                    ...
                    <option  {{ old('relation_id') == $value->id ? 'selected' : ''}} value="{{ $value->id }}" >
                        {{ $value->name }}</option>
                    @endforeach
                </select>
            </div>
