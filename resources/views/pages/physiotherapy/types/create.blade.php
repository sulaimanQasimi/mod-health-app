...
@section('title', localize('global.create_physiotherapy_type'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">{{ localize('global.create_physiotherapy_type') }}</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('physiotherapy-types.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              rows="4" 
                                              maxlength="1000"
                                              placeholder="{{ localize('global.enter_physiotherapy_type_description') }}">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-2">
                                            <small class="text-muted">
                                                ...
                                                {{ localize('global.created_at') }}: {{ now()->format('Y-m-d H:i') }}
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> {{ localize('global.create_physiotherapy_type') }}
                                    </button>
