        ...
        <div class="content-wrapper">
            ...
            <div id="prescription-index-app" 
                 ...
                 data-localize="{{ json_encode([
                     ...
                     'global.search_by_card_number' => localize('global.search_by_card_number'),
                     'global.search_by_father_name' => localize('global.search_by_father_name'),
                     'global.patient_id' => localize('global.patient_id'),
                     'global.search_by_patient_id' => localize('global.search_by_patient_id'),
