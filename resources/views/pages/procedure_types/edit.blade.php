            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{ localize('global.edit_procedure_type') }}</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('procedure_types.update', $iCUProcedureType->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ $iCUProcedureType->name }}" class="form-control">
                                    </div>
                                </div>
                            </div>
