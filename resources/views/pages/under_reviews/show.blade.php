                                ...
                                <div id="visitsCollapse" class="accordion-collapse collapse" aria-labelledby="visitsHeading"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="modal fade" id="createVisitModal{{ $underReview->id }}" tabindex="-1"
                                            aria-labelledby="createVisitModalLabel{{ $underReview->id }}"
                                            aria-hidden="true">
                                ...
                                <div id="hospitalizationCollapse" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="modal fade modal-xl"
                                            id="createHospitalizationModal{{ $underReview->id }}" tabindex="-1"
                                            aria-labelledby="createHospitalizationModalLabel{{ $underReview->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <form action="{{ route('hospitalizations.store') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control"
                                                                        id="reason{{ $underReview->id }}" name="reason"
                                                                        rows="3"></textarea>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row p-2">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <select class="form-control select2"
                                                                                name="food_type_id[]" id="food_type_id"
                                                                                multiple>
                                                                                <option value="">
                                                                                    {{ localize('global.select') }}
                                                                                </option>
                                                ...
                                                <tbody>
                                                    @forelse ($underReview->hospitalization as $hospitalization)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ route('hospitalizations.edit', $hospitalization->id) }}">
