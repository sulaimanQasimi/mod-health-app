...
@section('title', localize('edit_vital_sign'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit"></i> {{ localize('edit_vital_sign') }}
                    </h3>
                    <div class="card-tools">
                        <a href="{{ route('vital-signs.show', $vitalSign) }}" class="btn btn-secondary btn-sm">
                    ...
                    <form action="{{ route('vital-signs.update', $vitalSign) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('vital_sign_type_id') is-invalid @enderror" 
                                        ...
                                        @foreach($vitalSignTypes as $type)
                                            <option value="{{ $type->id }}" {{ old('vital_sign_type_id', $vitalSign->vital_sign_type_id) == $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('morphable_type') is-invalid @enderror" 
                                        ...
                                        <option value="App\Models\UnderReview" {{ old('morphable_type', $vitalSign->morphable_type) == 'App\Models\UnderReview' ? 'selected' : '' }}>
                                            {{ localize('under_review') }}
                                        </option>
                                        <option value="App\Models\Hospitalization" {{ old('morphable_type', $vitalSign->morphable_type) == 'App\Models\Hospitalization' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('morphable_id') is-invalid @enderror" 
                                           id="morphable_id" name="morphable_id" value="{{ old('morphable_id', $vitalSign->morphable_id) }}" 
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('vital-signs.show', $vitalSign) }}" class="btn btn-secondary">
