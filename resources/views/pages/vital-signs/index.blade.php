            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <input type="text" autocomplete="off" class="form-control form-control datepicker_dari pdp-el" id="date_from_filter" placeholder="{{ localize('global.date_from') }}">
                        </div>
                        <div class="col-md-3">
                            <input type="text" autocomplete="off" class="form-control form-control datepicker_dari pdp-el" id="date_to_filter" placeholder="{{ localize('global.date_to') }}">
                        </div>
                        <div class="col-md-3">
