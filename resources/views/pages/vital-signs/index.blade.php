                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <select class="form-control" id="vital_sign_type_filter">
                                <option value="">{{ localize('filter_by_type') }}</option>
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" id="search_filter" placeholder="{{ localize('search') }}...">
                        </div>
                    </div>
                            ...
                            <tbody>
                                @forelse($vitalSigns as $vitalSign)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $vitalSign->schedules->count() }} {{ localize('schedules') }}</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                @can('update', $vitalSign)
                                                    <a href="{{ route('vital-signs.edit', $vitalSign) }}" class="btn btn-warning btn-sm" title="{{ localize('edit') }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">{{ localize('no_vital_signs_found') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
